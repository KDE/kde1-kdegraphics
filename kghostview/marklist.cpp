...
//	setBackgroundColor( colorGroup().normal().light(120) );
	...
	pup->insertItem( "Mark current", this, SLOT(markSelected()) );
	pup->insertItem( "Mark all", this, SLOT(markAll()) );
	pup->insertItem( "Mark even", this, SLOT(markEven()) );
	pup->insertItem( "Mark odd", this, SLOT(markOdd()) );
	pup->insertItem( "Toggle marks", this, SLOT(toggleMarks()) );
	pup->insertItem( "Remove marks", this, SLOT(removeMarks()) );
